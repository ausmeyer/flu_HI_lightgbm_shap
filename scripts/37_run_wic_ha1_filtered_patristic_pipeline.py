#!/usr/bin/env python3
"""Run the WIC HA1 pipeline with patristic distance after excluding egg, mixed, and unknown passage classes."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--config", default="H3N2-WIC/config/wic_ha1_no_egg_mixed_unknown_patristic.json")
...
def main() -> None:
    ...
    run_step([sys.executable, "scripts/34_build_wic_ha1_patristic_tree.py", "--config", config])
