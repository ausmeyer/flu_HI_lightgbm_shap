...
def main() -> None:
    ...
    keep_names = {
        ...
        f"{subtype}_koel_context_effects.tsv",
        f"{subtype}_koel_context_site_contrast.tsv",
        f"{subtype}_koel_context_site_summary.tsv",
        f"{subtype}_koel_context_substitution_summary.tsv",
    ...
    keep_figures = {
        ...
        f"{subtype}_koel_context_dependence_145_155.pdf",
